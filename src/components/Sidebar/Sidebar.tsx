  ...
  return (
    <aside className="sidebar-inner">
      ...
      <div className="sidebar-search" style={{ position: "relative" }}>
        ...
        />
        {localSearch && (
          <button onClick={() => setLocalSearch("")} style={{ position: "absolute", right: 20, top: "50%", transform: "translateY(-50%)", border: "none", background: "none", color: "var(--text-faint)", cursor: "pointer", padding: 2, display: "flex", alignItems: "center" }} title="Clear search">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
